...
public class MediaPlayerCompat {
    ...
    public static int setSpeed(IMediaPlayer mp, float speed) {
        IjkMediaPlayer ijkMediaPlayer = getIjkMediaPlayer(mp);
        if (ijkMediaPlayer == null)
            return -1;
    ...
    public static float getSpeed(IMediaPlayer mp) {
        IjkMediaPlayer ijkMediaPlayer = getIjkMediaPlayer(mp);
        if (ijkMediaPlayer == null)
            return 0.0f;
    ...
    public static void setBitrate(IMediaPlayer mp, String bitrateName) {
        IjkMediaPlayer ijkMediaPlayer = getIjkMediaPlayer(mp);
        if (ijkMediaPlayer == null)
            return;
        ijkMediaPlayer.setBitrate(bitrateName);
    }
